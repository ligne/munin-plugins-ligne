...
This is just a brief overview.  The plugins should (eventually) contain more
detailed documentation in POD format.

=over 4

=item C<node.d/nagiostats_>

Statistics relating to Nagios performance.
L<http://nagios.sourceforge.net/docs/3_0/nagiostats.html>
